...
<div class="container-fluid container-fullw block-custom">

  <div class="row page-description">
    <div class="col-sm-8 col-lg-9">
      <p class="main-description">Add feature images, links, and optional text descriptions below:</p>
    </div>
          ...
          <table class="table-sortable expandable">
			...
			@foreach ($featuredContents as $featuredContent)
	              <tr class="subpanel" data-id="{{$featuredContent->id}}">
	                ...
	                <td class="">
	                  <input class="on" name="cta_text-{{$featuredContent->id}}" type="text" placeholder="CTA Button Text" data-orig-value="{{ $featuredContent->cta_text }}" value="{{ $featuredContent->cta_text }}"/>
	                </td>
	                <td class="">
	                ...
	                <td class="col-actions">
	                  <div>
	                    ...
	                    <a class="delete-confirm" data-object="content" href="{{ url('admin/movies/'.$movie->id.'/edit/sections/'.$currentSection->id.'/featured/'.$featuredContent->id.'/delete') }}">
            ...
            <tr class="nosort">
	              <td>
		              <a href="{{ url('admin/movies/'.$movie->id.'/edit/sections/'.$currentSection->id.'/featured/create?type=featured') }}" class="btn btn-success">Add New Feature</a>
	              </td>				
	          </tr> 
            </tbody>
          </table>
...
<!--
        <div class="panel-heading">
          <h5 class="panel-title">Add a Feature</h5>
        </div>
        <div class="panel-body">
          <form name="" role="form" class="form-inline">
            ...
            <button class="btn btn-success" type="submit">Add Feature</button>
          </form>
        </div>
-->
      ...
      <div class="panel panel-white panel-file-upload">
        <div class="panel-heading">
          <h5 class="panel-title">Featured Content Block Background Content</h5>
        </div>
